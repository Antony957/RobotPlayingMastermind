...
call_create "$CUBE_RED_SDF"   "lab06_block_red"    "$X"  "-${SPACING}" "$BLOCK_Z"
call_create "$CUBE_BLUE_SDF"  "lab06_block_blue"   "$X"   "0.0"        "$BLOCK_Z"
call_create "$CUBE_YELL_SDF"  "lab06_block_yellow" "$X"   "${SPACING}" "$BLOCK_Z"

# extra green block at y = 0.16 (the 4th one you already used)
CUBE_GREEN_SDF="${SDF_DIR}/cube_green.sdf"; write_cube_sdf "$CUBE_GREEN_SDF" 0.1 0.85 0.1
call_create "$CUBE_GREEN_SDF" "lab06_block_green" "$X" "0.16" "$BLOCK_Z"
...
call_create "$WHITE_SDF" "lab06_white_plate" 0.20 0.32 "$PLATE_Z"
